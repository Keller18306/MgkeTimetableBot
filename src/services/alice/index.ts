...
export class AliceApp {
    ...
    constructor(app: Application) {
        ...
        //         'Для того, чтобы получить расписание, вы можете установить себе на постоянно группу или имя учителя. Для этого можете сказать "Установи группу 63"',
        //         'Или же вы можете просто узнать расписание конкретной группы или учителя. Для этого можете сказать "Группа 63"'
        //     ].join('\n\n'))
        // })
